...
<%
    ...
    String entityUrl = PortalUtil.getLayoutURL(themeDisplay.getLayout(),themeDisplay);
    entityUrl = entityUrl.substring(0, entityUrl.indexOf("protocol")) + "entity-editor";
